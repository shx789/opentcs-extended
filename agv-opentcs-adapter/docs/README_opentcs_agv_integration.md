...
setsid env \
  ...
  python3 -u /home/shx/workspace/opentcs/opentcs/agv-opentcs-adapter/bin/agv_native_feedback_adapter.py \
  > /home/shx/workspace/opentcs/opentcs/agv-opentcs-adapter/logs/agv_native_feedback_adapter.log 2>&1 < /dev/null &
```
