...
DEFAULT_POINT_FILE = Path(
    "/home/shx/workspace/catkin_ws/src/ros_robot_control_json/json/interest_point.json"
)
STATUS_FILE = Path(
    os.environ.get(
...
async def run() -> None:
    ...
    point_file = Path(str(config.get("agv_point_file") or str(DEFAULT_POINT_FILE)))
