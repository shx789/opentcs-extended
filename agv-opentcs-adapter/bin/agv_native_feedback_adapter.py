...
ROOT = Path(os.environ.get('AGV_ADAPTER_ROOT', '/home/shx/workspace/map_mapping_output'))
DEFAULT_MAPPING_FILE = str(ROOT / 'agv_opentcs_business_topology_draft.json')
DEFAULT_STATUS_FILE = str(ROOT / 'agv_native_feedback_adapter_status.json')
DEFAULT_AGV_POINT_FILE = '/home/shx/workspace/catkin_ws/src/ros_robot_control_json/json/interest_point.json'
...
def load_config(previous: Optional[AdapterConfig] = None) -> Tuple[AdapterConfig, Optional[str]]:
    ...
    config = AdapterConfig(
        mapping_file=Path(runtime_value(raw, 'AGV_ADAPTER_MAPPING_FILE', 'mapping_file', DEFAULT_MAPPING_FILE)),
        ...
        status_file=Path(runtime_value(raw, 'AGV_ADAPTER_STATUS_FILE', 'status_file', DEFAULT_STATUS_FILE)),
        agv_point_file=Path(runtime_value(raw, 'AGV_ADAPTER_AGV_POINT_FILE', 'agv_point_file', DEFAULT_AGV_POINT_FILE)),
