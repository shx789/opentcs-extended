...
原始 openTCS 没有 RCS/WCS/AGV 集成样例。本分支在 link:settings.gradle[settings.gradle] 中新增：
...
在 link:gradle/libs.versions.toml[gradle/libs.versions.toml] 中新增 Eclipse Paho MQTT Client：
