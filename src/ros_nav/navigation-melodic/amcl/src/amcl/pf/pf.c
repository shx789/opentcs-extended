...
void pf_update_sensor(pf_t *pf, pf_sensor_model_fn_t sensor_fn, void *sensor_data)
{
  ...
  //add zxp
  Amcl_status.total = total;
  Amcl_status.have_new = 1;
  ...
  if (total > 0.0)
  {
    ...
    printf("w_avg:%f weight:%f n_effective:%f total:%f\r\n",w_avg,sample->weight,set->n_effective,total);
